...
export default async function BlurRegionPage({params}: PageProps) {
  const {locale} = await params;
  setRequestLocale(locale);
  return <ToolLandingShell locale={locale} copy={getToolLandingCopyForLocale(PATH, locale)} toolConfig={blurRegionToolConfig} />;
}
