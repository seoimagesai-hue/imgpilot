...
import {
  GeotagImageHeroUploadCta,
  GeotagImageResetCta,
} from "@/components/marketing/geotag-image-ctas";
...
function BenefitIcon({
  ...
  name: ReturnType<typeof getGeotagImageCopy>["benefits"]["cards"][number]["icon"];
}) {
    ...
    case "jpeg":
      return (
        <svg className={common} viewBox="0 0 24 24" fill="none" aria-hidden="true">
          ...
          <path d="M8 15l3-3 2 2 3-4 2 5" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      );
    case "replace":
      return (
        <svg className={common} viewBox="0 0 24 24" fill="none" aria-hidden="true">
          <path d="M4 7h11v4H4V7zM9 17h11v-4H9v4z" stroke="currentColor" strokeWidth="1.75" strokeLinejoin="round" />
          <path d="M7 11l-3 3 3 3M17 13l3-3-3-3" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      );
    case "mobile":
      return (
...
export function GeotagImageLandingView({locale}: {locale: string}) {
  ...
  return (
    ...
    >
      ...
      <section className="marketing-container pt-16 pb-10 md:pt-[72px] md:pb-12">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.95fr)] lg:gap-12">
          <div className={`max-w-[820px] space-y-5 ${isRtl ? "text-right" : ""}`}>
            ...
            <GeotagImageHeroUploadCta label={copy.hero.uploadCta} />
          </div>
          <div className="overflow-hidden rounded-[20px] bg-white ring-1 ring-[var(--border)]">
            <Image
              src="/illustrations/geotag-image-hero.webp"
      ...
      <section id="geotag-intro" className={`${sectionPad} bg-[#f8fafc]`}>
        <div className="marketing-container">
      ...
      <section className={`${sectionPad} bg-[#f8fafc]`}>
        <div className="marketing-container space-y-8">
          ...
          <div className="overflow-hidden rounded-[20px] bg-white ring-1 ring-[var(--border)]">
            <Image
              src="/illustrations/geotag-image-steps.webp"
        ...
        <div className="marketing-container">
          <div className="rounded-[22px] border border-[var(--border)] bg-[linear-gradient(135deg,#eff6ff_0%,#ffffff_55%,#f5f3ff_100%)] px-6 py-10 text-center shadow-[var(--shadow-soft)] sm:px-10 sm:py-12">
            ...
            <div className="mt-6 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
              <GeotagImageResetCta label={copy.cta.primaryLabel} />
              <Link
