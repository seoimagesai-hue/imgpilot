...
export function BulkCompressResetCta({label}: {label: string}) {
  return (
    <button
      type="button"
      ...
      onClick={() => {
        ...
        dispatchGuestToolReset("bulk-compress");
      }}
    >
      {label}
    </button>
...
export function BulkCompressHeroUploadCta({label}: {label: string}) {
  return (
    <button
      type="button"
...
export function BulkCompressLearnMoreCta({label}: {label: string}) {
  return (
    <a
      href="#bulk-compress-features"
