...
import {
  BulkResizeHeroUploadCta,
  BulkResizeLearnMoreCta,
  BulkResizeResetCta,
} from "@/components/marketing/bulk-resize-ctas";
...
function BenefitIcon({
  ...
  name: ReturnType<typeof getBulkResizeCopy>["benefits"]["cards"][number]["icon"];
}) {
  ...
  switch (name) {
    ...
    case "queue":
      return (
        <svg className={common} viewBox="0 0 24 24" fill="none" aria-hidden="true">
          <path d="M5 7h14M5 12h14M5 17h9" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
        </svg>
      );
    case "zip":
      return (
...
export function BulkResizeLandingView({locale}: {locale: string}) {
  ...
  return (
    ...
    >
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.95fr)] lg:gap-12">
          <div className={`max-w-[820px] space-y-5 ${isRtl ? "text-right" : ""}`}>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <BulkResizeHeroUploadCta label={copy.hero.uploadCta} />
              <BulkResizeLearnMoreCta label={copy.hero.learnMoreCta} />
            </div>
          </div>
          <div className="overflow-hidden rounded-[20px] bg-white ring-1 ring-[var(--border)]">
            <Image
              src="/illustrations/bulk-resize-hero.webp"
      ...
      <section id="bulk-resize-intro" className={sectionPad}>
        <div className="marketing-container grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
          ...
          >
            <Image
              src="/illustrations/bulk-resize-compare.webp"
      ...
      <section className={`${sectionPad} bg-[#f8fafc]`}>
        <div className="marketing-container space-y-8">
          ...
          <div className="overflow-hidden rounded-[20px] bg-white ring-1 ring-[var(--border)]">
            <Image
              src="/illustrations/bulk-resize-steps.webp"
        ...
        <div className="marketing-container">
          <div className={`mx-auto max-w-[820px] space-y-4 ${isRtl ? "text-right" : ""}`}>
            ...
            <ul className="space-y-3 rounded-[18px] border border-[var(--border)] bg-white p-6 shadow-[var(--shadow-soft)]">
              {copy.performance.points.map((point) => (
        ...
        <div className="marketing-container">
          <div className="rounded-[22px] border border-[var(--border)] bg-[linear-gradient(135deg,#eff6ff_0%,#ffffff_55%,#f5f3ff_100%)] px-6 py-10 text-center shadow-[var(--shadow-soft)] sm:px-10 sm:py-12">
            ...
            <div className="mt-6 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
              <BulkResizeResetCta label={copy.cta.primaryLabel} />
              <Link
