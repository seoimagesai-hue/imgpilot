...
export function BulkImageToolsResetCta({label}: {label: string}) {
  return (
    <button
      type="button"
      ...
      onClick={() => {
        ...
        dispatchGuestToolReset("bulk-image-tools");
      }}
    >
      {label}
    </button>
...
export function BulkImageToolsHeroUploadCta({label}: {label: string}) {
  return (
    <button
      type="button"
...
export function BulkImageToolsLearnMoreCta({label}: {label: string}) {
  return (
    <a
      href="#bulk-tools-modes"
