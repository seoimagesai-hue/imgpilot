...
export function BulkResizeResetCta({label}: {label: string}) {
  return (
    <button
      type="button"
      ...
      onClick={() => {
        ...
        dispatchGuestToolReset("bulk-resize");
      }}
    >
      {label}
    </button>
...
export function BulkResizeHeroUploadCta({label}: {label: string}) {
  return (
    <button
      type="button"
...
export function BulkResizeLearnMoreCta({label}: {label: string}) {
  return (
    <a
      href="#bulk-resize-intro"
