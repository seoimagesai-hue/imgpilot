...
export function ResizeImageResetCta({label}: {label: string}) {
  return (
    <button
      type="button"
      ...
      onClick={() => {
        ...
        dispatchGuestToolReset("resize-image");
      }}
    >
      {label}
    </button>
...
export function ResizeImageHeroUploadCta({label}: {label: string}) {
  return (
    <button
      type="button"
...
export function ResizeImageViewSizesCta({label}: {label: string}) {
  return (
    <a
      href="#resize-presets"
