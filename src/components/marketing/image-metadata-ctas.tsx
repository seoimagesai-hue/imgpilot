...
export function ImageMetadataResetCta({label}: {label: string}) {
  return (
    <button
      type="button"
      ...
      onClick={() => {
        ...
        dispatchGuestToolReset("image-metadata");
      }}
    >
      {label}
    </button>
...
export function ImageMetadataHeroUploadCta({label}: {label: string}) {
  return (
    <button
      type="button"
