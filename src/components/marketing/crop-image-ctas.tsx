...
export function CropImageResetCta({label}: {label: string}) {
  return (
    <button
      type="button"
      ...
      onClick={() => {
        ...
        dispatchGuestToolReset("crop-image");
      }}
    >
      {label}
    </button>
...
export function CropImageHeroUploadCta({label}: {label: string}) {
  return (
    <button
      type="button"
...
export function CropImageViewRatiosCta({label}: {label: string}) {
  return (
    <a
      href="#crop-ratios"
