...
export function ImageMetadataEditorResetCta({label}: {label: string}) {
  return (
    <button
      type="button"
      ...
      onClick={() => {
        ...
        dispatchGuestToolReset("image-metadata-editor");
      }}
    >
      {label}
    </button>
...
export function ImageMetadataEditorHeroUploadCta({label}: {label: string}) {
  return (
    <button
      type="button"
