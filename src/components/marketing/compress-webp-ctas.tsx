...
export function CompressWebpResetCta({label}: {label: string}) {
  return (
    <button
      type="button"
      ...
      onClick={() => {
        ...
        dispatchGuestToolReset("compress-webp");
      }}
    >
      {label}
    </button>
...
export function CompressWebpHeroUploadCta({label}: {label: string}) {
  return (
    <button
      type="button"
