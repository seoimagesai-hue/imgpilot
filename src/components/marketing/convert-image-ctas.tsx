...
export function ConvertImageResetCta({label}: {label: string}) {
  return (
    <button
      type="button"
      ...
      onClick={() => {
        ...
        dispatchGuestToolReset("convert-image");
      }}
    >
      {label}
    </button>
...
export function ConvertImageHeroUploadCta({label}: {label: string}) {
  return (
    <button
      type="button"
